...
MCL_CAMERA_RPY_DEG = (-105.0, 0.0, -90.0)
...
class MCLQuadObjectPushingR7CameraPlayEnvCfg(MCLQuadObjectPushingPlayEnvCfg):
    ...
    def __post_init__(self):
        super().__post_init__()
        # The R7 USD provides the visible floor. Remove Isaac's visible grid plane
        # and keep only an invisible physical plane at z=0 for stable contacts.
